...
number: across **145,591 articles** and the **958 sources** that account for all
...
credited 143 times (0.10%), and nationalist-fringe channels a further 179 (0.12%).
...
negative result — 145,591 articles, 958 sources, coverage 1.0000, zero credits to
