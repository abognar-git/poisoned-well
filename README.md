...
number: across **141,944 articles** and the **941 sources** that account for all
...
credited 83 times (0.06%), and nationalist-fringe channels a further 140 (0.10%).
...
negative result — 141,944 articles, 941 sources, coverage 1.0000, zero credits to
