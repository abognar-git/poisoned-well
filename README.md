...
number: across **144,014 articles** and the **946 sources** that account for all
...
on **893 of the 896 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 946 of them, accounting for 100.00% of
...
credited 107 times (0.07%), and nationalist-fringe channels a further 150 (0.10%).
...
negative result — 144,014 articles, 946 sources, coverage 1.0000, zero credits to
