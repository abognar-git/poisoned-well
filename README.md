...
number: across **147,810 articles** and the **960 sources** that account for all
...
on **916 of the 919 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 960 of them, accounting for 100.00% of
...
credited 164 times (0.11%), and nationalist-fringe channels a further 205 (0.14%).
...
negative result — 147,810 articles, 960 sources, coverage 1.0000, zero credits to
