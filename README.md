...
number: across **144,822 articles** and the **952 sources** that account for all
...
on **898 of the 901 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 952 of them, accounting for 100.00% of
...
credited 125 times (0.09%), and nationalist-fringe channels a further 163 (0.11%).
...
negative result — 144,822 articles, 952 sources, coverage 1.0000, zero credits to
