...
number: across **146,281 articles** and the **959 sources** that account for all
...
on **906 of the 909 days** since. Hungary held a national election on 12 April
...
credited 157 times (0.11%), and nationalist-fringe channels a further 195 (0.13%).
...
negative result — 146,281 articles, 959 sources, coverage 1.0000, zero credits to
