...
number: across **145,471 articles** and the **958 sources** that account for all
...
on **902 of the 905 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 958 of them, accounting for 100.00% of
...
credited 137 times (0.09%), and nationalist-fringe channels a further 173 (0.12%).
...
negative result — 145,471 articles, 958 sources, coverage 1.0000, zero credits to
