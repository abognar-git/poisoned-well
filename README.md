...
number: across **146,139 articles** and the **959 sources** that account for all
...
credited 156 times (0.11%), and nationalist-fringe channels a further 192 (0.13%).
...
negative result — 146,139 articles, 959 sources, coverage 1.0000, zero credits to
