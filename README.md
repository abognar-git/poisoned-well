...
number: across **142,241 articles** and the **941 sources** that account for all
...
credited 89 times (0.06%), and nationalist-fringe channels a further 143 (0.10%).
...
negative result — 142,241 articles, 941 sources, coverage 1.0000, zero credits to
