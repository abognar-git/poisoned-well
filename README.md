...
number: across **142,075 articles** and the **941 sources** that account for all
...
credited 87 times (0.06%), and nationalist-fringe channels a further 142 (0.10%).
...
negative result — 142,075 articles, 941 sources, coverage 1.0000, zero credits to
