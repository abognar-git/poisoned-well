...
number: across **144,950 articles** and the **954 sources** that account for all
...
published, and every source it credits — 954 of them, accounting for 100.00% of
...
negative result — 144,950 articles, 954 sources, coverage 1.0000, zero credits to
