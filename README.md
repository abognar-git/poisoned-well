...
number: across **144,530 articles** and the **950 sources** that account for all
...
on **896 of the 899 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 950 of them, accounting for 100.00% of
...
credited 122 times (0.08%), and nationalist-fringe channels a further 162 (0.11%).
...
negative result — 144,530 articles, 950 sources, coverage 1.0000, zero credits to
