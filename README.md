...
number: across **146,933 articles** and the **959 sources** that account for all
...
credited 163 times (0.11%), and nationalist-fringe channels a further 201 (0.14%).
...
negative result — 146,933 articles, 959 sources, coverage 1.0000, zero credits to
