...
number: across **145,736 articles** and the **958 sources** that account for all
...
on **903 of the 906 days** since. Hungary held a national election on 12 April
...
credited 146 times (0.10%), and nationalist-fringe channels a further 179 (0.12%).
...
negative result — 145,736 articles, 958 sources, coverage 1.0000, zero credits to
