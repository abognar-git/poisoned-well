...
number: across **143,266 articles** and the **945 sources** that account for all
...
on **889 of the 892 days** since. Hungary held a national election on 12 April
...
credited 95 times (0.07%), and nationalist-fringe channels a further 149 (0.10%).
...
negative result — 143,266 articles, 945 sources, coverage 1.0000, zero credits to
