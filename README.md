...
number: across **144,868 articles** and the **952 sources** that account for all
...
credited 125 times (0.09%), and nationalist-fringe channels a further 164 (0.11%).
...
negative result — 144,868 articles, 952 sources, coverage 1.0000, zero credits to
