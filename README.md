...
number: across **140,591 articles** and the **941 sources** that account for all
...
on **875 of the 878 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 941 of them, accounting for 100.00% of
...
credited 78 times (0.06%), and nationalist-fringe channels a further 132 (0.09%).
...
negative result — 140,591 articles, 941 sources, coverage 1.0000, zero credits to
