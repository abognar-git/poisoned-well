...
number: across **142,506 articles** and the **943 sources** that account for all
...
on **885 of the 888 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 943 of them, accounting for 100.00% of
...
credited 89 times (0.06%), and nationalist-fringe channels a further 145 (0.10%).
...
negative result — 142,506 articles, 943 sources, coverage 1.0000, zero credits to
