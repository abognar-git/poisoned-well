...
number: across **143,839 articles** and the **946 sources** that account for all
...
on **892 of the 895 days** since. Hungary held a national election on 12 April
...
credited 103 times (0.07%), and nationalist-fringe channels a further 150 (0.10%).
...
negative result — 143,839 articles, 946 sources, coverage 1.0000, zero credits to
