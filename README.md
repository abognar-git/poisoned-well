...
number: across **141,721 articles** and the **941 sources** that account for all
...
credited 79 times (0.06%), and nationalist-fringe channels a further 134 (0.09%).
...
negative result — 141,721 articles, 941 sources, coverage 1.0000, zero credits to
