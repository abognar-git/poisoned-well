...
number: across **141,401 articles** and the **941 sources** that account for all
...
on **879 of the 882 days** since. Hungary held a national election on 12 April
...
credited 78 times (0.06%), and nationalist-fringe channels a further 133 (0.09%).
...
negative result — 141,401 articles, 941 sources, coverage 1.0000, zero credits to
