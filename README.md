...
number: across **144,169 articles** and the **947 sources** that account for all
...
on **894 of the 897 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 947 of them, accounting for 100.00% of
...
credited 112 times (0.08%), and nationalist-fringe channels a further 156 (0.11%).
...
negative result — 144,169 articles, 947 sources, coverage 1.0000, zero credits to
