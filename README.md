...
number: across **144,907 articles** and the **953 sources** that account for all
...
on **899 of the 902 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 953 of them, accounting for 100.00% of
...
credited 126 times (0.09%), and nationalist-fringe channels a further 164 (0.11%).
...
negative result — 144,907 articles, 953 sources, coverage 1.0000, zero credits to
