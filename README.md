...
number: across **144,114 articles** and the **947 sources** that account for all
...
credited 107 times (0.07%), and nationalist-fringe channels a further 151 (0.10%).
...
negative result — 144,114 articles, 947 sources, coverage 1.0000, zero credits to
