...
number: across **146,856 articles** and the **959 sources** that account for all
...
credited 162 times (0.11%), and nationalist-fringe channels a further 200 (0.14%).
...
negative result — 146,856 articles, 959 sources, coverage 1.0000, zero credits to
