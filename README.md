...
number: across **147,615 articles** and the **959 sources** that account for all
...
on **915 of the 918 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 959 of them, accounting for 100.00% of
...
credited 163 times (0.11%), and nationalist-fringe channels a further 205 (0.14%).
...
negative result — 147,615 articles, 959 sources, coverage 1.0000, zero credits to
