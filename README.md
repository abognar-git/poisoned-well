...
number: across **141,831 articles** and the **941 sources** that account for all
...
on **882 of the 885 days** since. Hungary held a national election on 12 April
...
credited 80 times (0.06%), and nationalist-fringe channels a further 134 (0.09%).
...
negative result — 141,831 articles, 941 sources, coverage 1.0000, zero credits to
