...
number: across **142,744 articles** and the **944 sources** that account for all
...
on **886 of the 889 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 944 of them, accounting for 100.00% of
...
credited 92 times (0.06%), and nationalist-fringe channels a further 145 (0.10%).
...
negative result — 142,744 articles, 944 sources, coverage 1.0000, zero credits to
