...
number: across **142,971 articles** and the **945 sources** that account for all
...
on **888 of the 891 days** since. Hungary held a national election on 12 April
...
credited 95 times (0.07%), and nationalist-fringe channels a further 146 (0.10%).
...
negative result — 142,971 articles, 945 sources, coverage 1.0000, zero credits to
