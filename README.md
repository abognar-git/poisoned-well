...
number: across **146,440 articles** and the **959 sources** that account for all
...
on **907 of the 910 days** since. Hungary held a national election on 12 April
...
credited 160 times (0.11%), and nationalist-fringe channels a further 197 (0.13%).
...
negative result — 146,440 articles, 959 sources, coverage 1.0000, zero credits to
