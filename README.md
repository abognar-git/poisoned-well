...
number: across **146,786 articles** and the **959 sources** that account for all
...
on **910 of the 913 days** since. Hungary held a national election on 12 April
...
credited 162 times (0.11%), and nationalist-fringe channels a further 199 (0.14%).
...
negative result — 146,786 articles, 959 sources, coverage 1.0000, zero credits to
