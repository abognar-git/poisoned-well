...
number: across **141,654 articles** and the **941 sources** that account for all
...
on **881 of the 884 days** since. Hungary held a national election on 12 April
...
credited 79 times (0.06%), and nationalist-fringe channels a further 133 (0.09%).
...
negative result — 141,654 articles, 941 sources, coverage 1.0000, zero credits to
