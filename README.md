...
number: across **144,359 articles** and the **948 sources** that account for all
...
on **895 of the 898 days** since. Hungary held a national election on 12 April
...
published, and every source it credits — 948 of them, accounting for 100.00% of
...
credited 117 times (0.08%), and nationalist-fringe channels a further 159 (0.11%).
...
negative result — 144,359 articles, 948 sources, coverage 1.0000, zero credits to
