...
number: across **142,384 articles** and the **942 sources** that account for all
...
published, and every source it credits — 942 of them, accounting for 100.00% of
...
negative result — 142,384 articles, 942 sources, coverage 1.0000, zero credits to
