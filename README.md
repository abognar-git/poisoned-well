...
number: across **143,717 articles** and the **946 sources** that account for all
...
credited 98 times (0.07%), and nationalist-fringe channels a further 149 (0.10%).
...
negative result — 143,717 articles, 946 sources, coverage 1.0000, zero credits to
