...
number: across **146,076 articles** and the **959 sources** that account for all
...
on **905 of the 908 days** since. Hungary held a national election on 12 April
...
credited 155 times (0.11%), and nationalist-fringe channels a further 190 (0.13%).
...
negative result — 146,076 articles, 959 sources, coverage 1.0000, zero credits to
