...
number: across **145,093 articles** and the **955 sources** that account for all
...
credited 131 times (0.09%), and nationalist-fringe channels a further 166 (0.11%).
...
negative result — 145,093 articles, 955 sources, coverage 1.0000, zero credits to
