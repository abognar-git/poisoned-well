...
number: across **147,145 articles** and the **959 sources** that account for all
...
on **911 of the 914 days** since. Hungary held a national election on 12 April
...
credited 163 times (0.11%), and nationalist-fringe channels a further 203 (0.14%).
...
negative result — 147,145 articles, 959 sources, coverage 1.0000, zero credits to
