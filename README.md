...
number: across **145,406 articles** and the **957 sources** that account for all
...
published, and every source it credits — 957 of them, accounting for 100.00% of
...
negative result — 145,406 articles, 957 sources, coverage 1.0000, zero credits to
