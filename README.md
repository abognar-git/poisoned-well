...
number: across **142,191 articles** and the **941 sources** that account for all
...
on **883 of the 886 days** since. Hungary held a national election on 12 April
...
credited 88 times (0.06%), and nationalist-fringe channels a further 142 (0.10%).
...
negative result — 142,191 articles, 941 sources, coverage 1.0000, zero credits to
