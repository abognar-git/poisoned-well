...
number: across **145,901 articles** and the **959 sources** that account for all
...
credited 152 times (0.10%), and nationalist-fringe channels a further 183 (0.13%).
...
negative result — 145,901 articles, 959 sources, coverage 1.0000, zero credits to
