...
number: across **142,920 articles** and the **945 sources** that account for all
...
on **887 of the 890 days** since. Hungary held a national election on 12 April
...
credited 93 times (0.07%), and nationalist-fringe channels a further 145 (0.10%).
...
negative result — 142,920 articles, 945 sources, coverage 1.0000, zero credits to
