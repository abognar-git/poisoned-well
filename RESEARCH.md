...
> provenance census — zero credits to the Hungarian pro-government press across 147,783 articles — and
...
Across all 147,783 articles, the 960 credited sources sum to exactly 147,783 (coverage 1.0000). The
...
| M7 | Manual pass over all 960 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
