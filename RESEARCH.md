...
> provenance census — zero credits to the Hungarian pro-government press across 144,169 articles — and
...
Across all 144,169 articles, the 947 credited sources sum to exactly 144,169 (coverage 1.0000). The
...
| M7 | Manual pass over all 947 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
