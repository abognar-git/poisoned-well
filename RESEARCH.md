...
> provenance census — zero credits to the Hungarian pro-government press across 142,744 articles — and
...
Across all 142,744 articles, the 944 credited sources sum to exactly 142,744 (coverage 1.0000). The
...
| M7 | Manual pass over all 944 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
