...
> provenance census — zero credits to the Hungarian pro-government press across 145,525 articles — and
...
Across all 145,525 articles, the 958 credited sources sum to exactly 145,525 (coverage 1.0000). The
...
| M7 | Manual pass over all 958 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
