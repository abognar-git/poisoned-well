...
> provenance census — zero credits to the Hungarian pro-government press across 146,291 articles — and
...
Across all 146,291 articles, the 959 credited sources sum to exactly 146,291 (coverage 1.0000). The
...
| M7 | Manual pass over all 959 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
