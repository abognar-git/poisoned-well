...
> provenance census — zero credits to the Hungarian pro-government press across 144,822 articles — and
...
Across all 144,822 articles, the 952 credited sources sum to exactly 144,822 (coverage 1.0000). The
...
| M7 | Manual pass over all 952 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
