...
> provenance census — zero credits to the Hungarian pro-government press across 144,530 articles — and
...
Across all 144,530 articles, the 950 credited sources sum to exactly 144,530 (coverage 1.0000). The
...
| M7 | Manual pass over all 950 sources for Hungarian markers | hardens the headline zero from "robust to my string list" to "exhaustively verified" | ~1 day | **PI** — this is the number that will be quoted |
